      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl md:text-6xl font-black font-comic mb-4">
            Meet <span className="text-nanobanana-yellow">Jeffrey!</span>
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          {/* Left - Jeffrey Image and Features */}
          <motion.div
            ...
            <div className="relative mb-8">
              ...
              >
                <p className="font-comic font-bold text-sm">
                  Hi! I'm Jeffrey! <span className="text-nanobanana-yellow">Ready to learn?</span>
                </p>
              </motion.div>
            </div>
